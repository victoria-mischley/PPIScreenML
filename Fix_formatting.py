...
def main(file_path, protein1_chains_input, protein2_chains_input):
    ...
    # Export the modified PandasPdb object to a PDB file
    output_file_path = Path(file_path).stem + "_dif_chains_modifiedtest.pdb"
    AF.to_pdb(path=output_file_path, records=['ATOM'], gz=False, append_newline=True)
