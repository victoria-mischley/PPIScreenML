...
def main(working_directory, num_chains_protein_B, interface_cutoff):
    ...
    for i,file in enumerate(pdb_files):
        if file != ".DS_Store":
            ...
            BE_complex_name = f"BE_complex_{interface_cutoff_str}A"
            BE_bining_energy_name = f"BE_bining_energy_{interface_cutoff_str}A"
            fa_atr_complex_name = f"fa_atr_complex_{interface_cutoff_str}A"
            fa_atr_binding_name = f"fa_atr_binding_{interface_cutoff_str}A"
            fa_rep_complex_name = f"fa_rep_complex_{interface_cutoff_str}A"
            fa_rep_binding_name = f"fa_rep_binding_{interface_cutoff_str}A"
            fa_sol_complex_name = f"fa_sol_complex_{interface_cutoff_str}A"
            fa_sol_binding_name = f"fa_sol_binding_{interface_cutoff_str}A"
            fa_elec_complex_name = f"fa_elec_complex_{interface_cutoff_str}A"
            fa_elec_binding_name = f"fa_elec_binding_{interface_cutoff_str}A"
            lk_ball_wtd_complex_name = f"lk_ball_wtd_complex_{interface_cutoff_str}A"
            lk_ball_wtd_binding_name = f"lk_ball_wtd_binding_{interface_cutoff_str}A"
            pro_close_complex_name = f"pro_close_complex_{interface_cutoff_str}A"
            p_aa_pp_complex_name = f"p_aa_pp_complex_{interface_cutoff_str}A"
            fa_dun_complex_name = f"fa_dun_complex_{interface_cutoff_str}A"
            rama_prepro_complex_name = f"rama_prepro_complex_{interface_cutoff_str}A"
            Num_IF_H_bonds_name = f"Num_IF_H_bonds_{interface_cutoff_str}A"
            avg_IF_atr_name = f"avg_IF_atr_{interface_cutoff_str}A"
            avg_IF_rep_name = f"avg_IF_rep_{interface_cutoff_str}A"
            avg_IF_sol_name = f"avg_IF_sol_{interface_cutoff_str}A"
            avg_IF_elec_name = f"avg_IF_elec_{interface_cutoff_str}A"
            avg_fa_dun_name = f"avg_fa_dun_{interface_cutoff_str}A"
            avg_hbond_bb_sc_name = f"avg_hbond_bb_sc_{interface_cutoff_str}A"
            prop_IF_SS_helix_name = f"prop_IF_SS_helix_{interface_cutoff_str}A"
            prop_IF_SS_sheet_name = f"prop_IF_SS_sheet_{interface_cutoff_str}A"
            prop_IF_SS_loop_name = f"prop_IF_SS_loop_{interface_cutoff_str}A"
            SASA_complex_name = f"SASA_complex_{interface_cutoff_str}A"
            buried_SASA_name = f"buried_SASA_{interface_cutoff_str}A"
